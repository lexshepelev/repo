...
| [Спрос на рейсы авиакомпании](Спрос-на-рейсы-авиакомпании) | Нужно проанализировать предпочтения пользователей, покупающих билеты на разные направления. |`pandas` `matplotlib`|
